...
1. สถานการณ์ลูกค้า (2-4 ประโยค):
   ...
   - ประเด็น 06: situation — ลูกค้ากังวลเรื่องนี้ไหม (ดู surviving_spouse_plan) ทรัพย์สินหลักมีอะไรบ้าง ชื่อโฉนดหรือบัญชีใคร ถ้ายกทุกอย่างให้คู่สมรสโดยไม่มีเงื่อนไขจะเกิดอะไรขึ้น
...
2. คำแนะนำ (2-4 bullet ขึ้นต้นด้วย "- "):
   ...
   - ประเด็น 09:
     ...
     bullet 3 — พูดคุยให้ผู้ดูแลเงินเข้าใจว่าผู้ดูแลเงินมีหน้าที่ตามกฎหมายในการบริหารทรัพย์สินเพื่อประโยชน์ของเด็กเท่านั้น ไม่ใช่ของตัวเอง และต้องพร้อมรับผิดชอบหากมีการร้องเรียน พร้อมรายงานการใช้จ่ายต่อศาลเป็นระยะตามที่กฎหมายกำหนด
   - ประเด็น 10:
...
- ตรวจสอบความถูกต้องของคำก่อนส่ง เช่น คำว่า "พร้อม" ไม่ใช่ "พร้วม"
...
กฎ:
1. typo ภาษาไทย เช่น "ทรัพย์" ไม่ใช่ "ทรัพ์" "พร้อม" ไม่ใช่ "พร้วม" "สะสมทรัพย์" ไม่ใช่ "สะสมทรัพ์"
2. ห้ามคำภาษาอังกฤษ ยกเว้น Keyman Insurance, AFPT, Settlement Option, Term
3. ห้ามวงเล็บภาษาอังกฤษ
4. ตัวเลขต้องสอดคล้องกัน ไม่ขัดแย้งกันเอง
5. ส่งกลับ JSON เหมือนเดิมทุกอย่าง แก้แค่จุดที่ผิด ไม่เพิ่มหรือลดเนื้อหา
