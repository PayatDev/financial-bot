...
2. คำแนะนำ (2-4 bullet ขึ้นต้นด้วย "- "):
   ...
   - ประเด็น 11:
     ...
     situation — ลูกค้าอายุเท่าไหร่ตอนทำแผนนี้ คู่สมรสอายุเท่าไหร่ ลูกแต่ละคนอายุเท่าไหร่ สรุปสถานะแต่ละประเด็น (✅/⚠️/❌) ซึ่งส่วนที่ทำได้ทันทีแล้วมีอะไรบ้าง และสิ่งที่ยังยากที่สุดคือประกันชีวิต โรคร้าย และทุพพลภาพที่ยังต้องติดตามต่อ
