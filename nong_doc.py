...
GENERAL_PRINCIPLES = {
    1: "ทันทีที่เราจากไป โลกไม่ได้หยุดรอ มีค่าใช้จ่ายเกิดขึ้นภายในไม่กี่ชั่วโมง ทั้งค่าจัดการศพ ค่าโรงพยาบาล ค่าธรรมเนียมแจ้งตาย ไปจนถึงค่าจ้างทนายดำเนินเรื่องต่างๆ สิ่งเหล่านี้ต้องใช้เงินสดทันที ก่อนที่ใครจะได้เงินจากมรดกหรือประกันสักบาท ถ้าไม่เตรียมไว้ คนที่รักต้องควักเงินตัวเองจ่ายก่อนในช่วงเวลาที่เจ็บปวดที่สุดในชีวิต",
    2: "การสูญเสียคนในครอบครัวไม่ได้กระทบแค่ความรู้สึก แต่เขย่าวิถีชีวิตทุกด้านพร้อมกัน คนที่รอดชีวิตอาจต้องลาออกหรือลดเวลาทำงานเพื่อดูแลลูกและจัดการมรดก บ้านยังต้องผ่อน ค่าใช้จ่ายประจำวันยังเดินหน้า แต่รายได้หายไปครึ่งหนึ่ง ช่วง 6–12 เดือนแรกคือช่วงที่หนักที่สุดและต้องการเงินก้อนพิเศษรองรับ",
    3: "เมื่อเราจากไป ไม่ใช่แค่ตัวเราที่หายไป แต่รายได้ที่เราจะสร้างได้อีกหลายสิบปีก็หายไปด้วย ประกันชีวิตที่ดีควรเข้ามาเติมเต็มส่วนนี้ให้ครอบครัว เสมือนว่าเรายังคงหาเงินให้พวกเขาได้อยู่ แม้จะไม่ได้อยู่แล้ว นี่คือหัวใจของการวางแผนประกันชีวิต",
    4: "ถ้ามีกิจการส่วนตัว การจากไปกะทันหันอาจทำให้กิจการหยุดชะงัก เพราะไม่มีใครมีอำนาจลงนามหรืออนุมัติงานต่อได้ทันที ยิ่งถ้าครอบครัวยังต้องพึ่งรายได้จากกิจการนั้น ความล่าช้าในการส่งมอบอาจกลายเป็นภาระซ้ำซ้อนในช่วงเวลาที่ยากที่สุดอยู่แล้ว",
    5: "ความตายไม่ใช่ความเสี่ยงเดียวที่ต้องเตรียมรับมือ การพิการหรือป่วยหนักจนทำงานไม่ได้อาจสร้างภาระมากกว่า เพราะยังมีชีวิตอยู่แต่หาเงินไม่ได้ แถมยังมีค่ารักษาพยาบาลพิเศษเพิ่มเข้ามาอีก ที่สำคัญคือประกันชีวิตธรรมดาไม่จ่ายในกรณีนี้",
    6: "ถ้าพินัยกรรมยกทุกอย่างให้คู่สมรสโดยไม่มีเงื่อนไข และวันหนึ่งคู่สมรสแต่งงานใหม่ ทรัพย์สินที่เราสร้างมาทั้งชีวิตอาจไหลไปสู่ครอบครัวใหม่ แทนที่จะถึงมือลูกแท้ๆ ของเรา เหตุการณ์แบบนี้ไม่ได้เกิดจากเจตนาร้าย แต่เกิดจากพินัยกรรมที่ไม่ได้วางแผนไว้ล่วงหน้า",
    7: "พินัยกรรมส่วนใหญ่เขียนขึ้นโดยสมมติว่าคู่สมรสยังมีชีวิตอยู่ แต่ถ้าทั้งสองจากไปพร้อมกันหรือคู่สมรสจากไปก่อน โดยที่ไม่มีแผนสำรอง มรดกจะกระจายตามกฎหมาย ซึ่งในไทยหมายความว่าปู่ย่าตายายมีสิทธิ์รับมรดกในลำดับเดียวกับลูก ไม่ใช่แค่ลูกอย่างเดียว",
    8: "อุบัติเหตุที่พรากพ่อแม่ทั้งสองในคราวเดียวเป็นเหตุการณ์ที่ไม่มีใครอยากคิดถึง แต่ถ้าเกิดขึ้นจริงและไม่ได้วางแผนไว้ ศาลจะเป็นผู้ตัดสินว่าลูกจะไปอยู่กับใคร ระหว่างรอคำสั่ง อาจเกิดความวุ่นวายในครอบครัว ทั้งการแย่งตัวเด็กและการเกี่ยงกันรับผิดชอบ",
    ...
    10: "เด็กที่ได้รับมรดกก้อนใหญ่ทันทีที่บรรลุนิติภาวะ โดยที่ยังไม่มีประสบการณ์บริหารเงิน มักไม่ได้ผลลัพธ์ที่พ่อแม่หวังไว้ การกำหนดเงื่อนไขในพินัยกรรม เช่น ให้รับเมื่ออายุ 25 หรือ 30 ปี หรือให้ทยอยรับเป็นรายปี คือวิธีที่พ่อแม่ดูแลลูกข้ามเวลาได้",
    11: "เมื่อเกิดเหตุ ทุกอย่างวุ่นวายมาก คนที่รับหน้าที่ต้องรู้ว่าเอกสารอยู่ที่ไหน บัญชีมีอะไรบ้าง ใครต้องติดต่อก่อน และสิทธิ์อะไรที่ต้องเรียกร้องภายในกี่วัน ถ้าไม่มีคู่มือไว้ล่วงหน้า ความล่าช้าอาจทำให้ครอบครัวเสียสิทธิ์หรือได้รับเงินช้ากว่าที่ควร",
...
1. ย่อหน้าลูกค้า (2-3 ประโยค): เล่าสถานการณ์จริงของลูกค้าที่เกี่ยวกับประเด็นนี้ ใช้ชื่อจริง ตัวเลขจริง เป็นเรื่องราว ไม่ใช่หลักการทั่วไป

2. การจัดการในปัจจุบัน (2-3 ประโยค): สรุปจาก "แนะนำ" และ "ความเห็นคุณพยัต" ให้อ่านง่าย กระชับ ใส่ตัวเลขถ้ามี

output เป็น JSON เท่านั้น ไม่มีข้อความอื่น:
[{{"ลำดับ": 1, "ย่อหน้าลูกค้า": "...", "การจัดการในปัจจุบัน": "..."}}]"""
...
def build_cover(client_data: dict, issues: list, generated: dict, folder_name: str) -> str:
    ...
    # ── Intro ─────────────────────────────────────────────────────────
    intro_texts = [
        "การทำพินัยกรรมนั้น ถ้ามองแค่ขั้นตอน ก็ไม่ยากเลย แค่เขียนข้อความบอกว่าอยากให้ทรัพย์สินไปอยู่ที่ไหน ลงวันที่ แล้วเซ็นชื่อต่อหน้าพยาน 2 คน เท่านี้ก็ถูกต้องตามกฎหมายแล้ว",
        f"แต่สำหรับพ่อแม่ที่มีลูกเล็กๆ เรื่องนี้ต้องคิดให้ไกลกว่านั้น เพราะสิ่งที่คุณต้องการจริงๆ ไม่ใช่แค่เอกสารที่ถูกกฎหมาย แต่คือความมั่นใจว่าถ้าวันหนึ่งเกิดเหตุไม่คาดฝัน ลูกๆ จะยังมีคนดูแล มีเงินพอใช้ และได้รับสิ่งที่คุณตั้งใจไว้ให้จริงๆ",
    ...
    add_run(dp, "คำแนะนำด้านประกันเป็นการประเมินเบื้องต้นเพื่อให้เห็นภาพรวมเท่านั้น หากต้องการวางแผนที่เหมาะกับสถานการณ์จริง กรุณาติดต่อเพื่อจัดทำแผนประกันเฉพาะบุคคลแยกต่างหาก", size=13, color=RGBColor(0x7A, 0x58, 0x00))
