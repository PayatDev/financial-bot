...
GENERAL_PRINCIPLES = {
    ...
    2: "การสูญเสียคนในครอบครัวไม่ได้กระทบแค่ความรู้สึก แต่เขย่าวิถีชีวิตทุกด้านพร้อมกัน คนที่มีชีวิตอยู่ต่ออาจต้องลาออกหรือลดเวลาทำงานเพื่อดูแลลูกๆและจัดการมรดก บ้านก็ยังต้องผ่อน ไหนจะค่าใช้จ่ายประจำวัน แต่รายได้หายไปครึ่งหนึ่ง ช่วง 6–12 เดือนแรกคือช่วงที่หนักที่สุดและต้องการเงินก้อนพิเศษรองรับ",
...
def build_cover(client_data: dict, issues: list, generated: dict, folder_name: str) -> str:
    ...
    # ── Intro ─────────────────────────────────────────────────────────
    intro_texts = [
        "การทำพินัยกรรมนั้น ถ้ามองแค่วิธีการจัดทำนั้น ไม่ยากเลย เพียงแค่เขียนข้อความบอกว่าอยากให้ทรัพย์สินไปอยู่ที่ไหน ลงวันที่ แล้วเซ็นชื่อต่อหน้าพยาน 2 คน เท่านี้ก็ถูกต้องตามกฎหมาย ทายาทสามารถนำไปให้ศาลออกคำสั่งต่างๆได้แล้ว",
        f"แต่สำหรับพ่อแม่ที่มีลูกเล็กๆ เรื่องนี้ต้องคิดให้ไกลกว่านั้น เพราะสิ่งที่คุณต้องการจริงๆ ไม่ใช่แค่เอกสารที่ถูกกฎหมาย แต่คือแผนที่ทำให้คุณมั่นใจว่าถ้าวันหนึ่งเกิดเหตุไม่คาดฝัน คู่ชีวิตจะไม่บำลาก ลูกๆจะยังมีคนดูแล มีเงินพอใช้ และได้รับสิ่งที่คุณตั้งใจไว้ให้จริงๆ",
