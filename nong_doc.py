...
def build_cover(client_data: dict, issues: list, generated: dict, folder_name: str) -> str:
    ...
    intro_texts = [
        ...
        f"แต่สำหรับพ่อแม่ที่มีลูกเล็ก เรื่องนี้ต้องคิดให้ไกลกว่านั้น เพราะสิ่งที่คุณต้องการจริงๆ ไม่ใช่แค่เอกสารที่ถูกกฎหมาย แต่มันคือแผน แผนที่ทำให้คุณมั่นใจว่าถ้าวันหนึ่งเกิดเหตุไม่คาดฝัน คู่ชีวิตจะไม่บำลาก ลูกๆจะยังมีคนดูแล ครอบครัวจะมีเงินพอใช้ และจะได้รับสิ่งที่คุณตั้งใจให้จริงๆ",
