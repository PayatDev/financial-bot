...
GENERAL_PRINCIPLES = {
    ...
    11: "เมื่อเกิดเหตุไม่คาดฝันขึ้น ทุกอย่างจะวุ่นวายมาก คนที่รับหน้าที่จัดการเรื่อง ต้องรู้ว่าเอกสารอยู่ที่ไหน และจะเปิดเอกสารเอกสารเมื่อไหร่ ต้องตัดสินใจเรื่องสำคัญอย่างไร บัญชีมีอะไรบ้าง และสิทธิ์อะไรที่ต้องเรียกร้อง(ภายในกี่วัน) ถ้าไม่มีคู่มือไว้ล่วงหน้า ความล่าช้าอาจทำให้ครอบครัวเสียสิทธิ์หรือได้รับเงินช้ากว่าที่ควร",
...
def build_cover(client_data: dict, issues: list, generated: dict, folder_name: str) -> str:
    ...
    intro_texts = [
        ...
        f"แต่สำหรับพ่อแม่ที่มีลูกเล็ก เรื่องนี้ต้องคิดให้ไกลกว่านั้น เพราะสิ่งที่คุณต้องการจริงๆ ไม่ใช่แค่เอกสารที่ถูกกฎหมาย แต่มันคือแผน แผนที่ทำให้คุณมั่นใจว่าถ้าวันหนึ่งเกิดเหตุไม่คาดฝัน คู่ชีวิตจะไม่บำลาก ลูกๆจะยังมีคนดูแล ครอบครัวจะมีเงินพอใช้และจะได้รับสิ่งที่คุณตั้งใจให้จริงๆ",
    ...
    add_run(dp, "คำแนะนำด้านประกันชีวิตเป็นการประเมินเบื้องต้นเพื่อให้เห็นภาพรวมเท่านั้น หากต้องการวางแผนที่เหมาะกับสถานการณ์จริง กรุณาติดต่อผม(payat.jira@gmail.com) เพื่อจัดทำแผนประกันภัยเฉพาะบุคคลแยกต่างหาก", size=13, color=RGBColor(0x7A, 0x58, 0x00))
