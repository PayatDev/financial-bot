...
def save_to_sheets(line_user_id: str, data: dict):
    try:
        ...
        row = [
            ...
            data.get("fullname_self", ""),
            data.get("id_self", ""),
            data.get("address_self", ""),
            data.get("fullname_spouse", ""),
            data.get("id_spouse", ""),
            data.get("fullname_children", ""),
            data.get("fullname_executor", ""),
            data.get("id_executor", ""),
            data.get("fullname_executor_backup", ""),
            data.get("id_executor_backup", ""),
            data.get("fullname_guardian_primary", ""),
            data.get("id_guardian_primary", ""),
            data.get("fullname_guardian_backup", ""),
            data.get("id_guardian_backup", ""),
            data.get("fullname_money_guardian_primary", ""),
            data.get("id_money_guardian_primary", ""),
            data.get("fullname_money_guardian_backup", ""),
            data.get("id_money_guardian_backup", ""),
