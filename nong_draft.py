...
FIXED_ISSUES = [
    ...
    {
        "ลำดับ": 10,
        "ประเด็น": "เอกสารอยู่ที่ไหนและใครรู้บ้าง",
        "อธิบาย": "เมื่อเกิดเหตุไม่คาดฝัน ทุกอย่างวุ่นวายมาก คนที่รับหน้าที่จัดการจำเป็นต้องรู้ว่าเอกสารอยู่ที่ไหน ต้องเริ่มจากอะไร และดำเนินการอะไรก่อนหลัง หากไม่มีการเตรียมไว้ล่วงหน้า ความล่าช้าอาจทำให้ครอบครัวเสียสิทธิ์หรือได้รับเงินช้ากว่าที่ควร",
        "กรณีไม่จัดการ": "ผู้จัดการมรดกต้องเริ่มตามหาเอกสารเองในช่วงที่เจ็บปวดที่สุด อาจตกหล่นสิทธิ์สำคัญที่มีกำหนดเวลา เช่น สวัสดิการ ประกัน หรือภาษี",
    },
    {
        "ลำดับ": 11,
        "ประเด็น": "ทบทวนแผนทุกปี",
        "อธิบาย": "ชีวิตเปลี่ยนตลอดเวลา อาจมีลูกเพิ่มขึ้น รายได้เพิ่มหรือลด ผู้ดูแลที่เลือกไว้อาจเสียชีวิตก่อน แผนที่ดี คือแผนที่ปรับให้ทันต่อสถานการณ์ปัจจุบันอยู่ตลอด",
        "กรณีไม่จัดการ": "พินัยกรรมที่ไม่เคยทบทวน มักเป็นพินัยกรรมที่สร้างปัญหาแทนที่แก้ปัญหา เพราะข้อมูลล้าสมัยไปตามชีวิตที่เปลี่ยนแปลง",
    },
    {
        "ลำดับ": 12,
...
FIELD_LABELS = [
    ...
    ("letter_to_children", "จดหมายถึงลูก"), 
    ("letter_to_spouse", "จดหมายถึงคู่สมรส"),
    ("fullname_self",                    "ชื่อ-นามสกุลจริงเจ้าของแผน"),
    ("id_self",                          "เลขบัตรประชาชนเจ้าของแผน"),
    ("address_self",                     "ที่อยู่ปัจจุบัน"),
    ("fullname_spouse",                  "ชื่อ-นามสกุลจริงคู่สมรส"),
    ("id_spouse",                        "เลขบัตรประชาชนคู่สมรส"),
    ("fullname_children",                "ชื่อ-นามสกุลจริงลูก (ทุกคน)"),
    ("fullname_executor",                "ชื่อ-นามสกุลจริงผู้จัดการมรดก"),
    ("id_executor",                      "เลขบัตรประชาชนผู้จัดการมรดก"),
    ("fullname_executor_backup",         "ชื่อ-นามสกุลจริงผู้จัดการมรดกสำรอง"),
    ("id_executor_backup",               "เลขบัตรประชาชนผู้จัดการมรดกสำรอง"),
    ("fullname_guardian_primary",        "ชื่อ-นามสกุลจริงผู้ปกครองหลัก"),
    ("id_guardian_primary",              "เลขบัตรประชาชนผู้ปกครองหลัก"),
    ("fullname_guardian_backup",         "ชื่อ-นามสกุลจริงผู้ปกครองสำรอง"),
    ("id_guardian_backup",               "เลขบัตรประชาชนผู้ปกครองสำรอง"),
    ("fullname_money_guardian_primary",  "ชื่อ-นามสกุลจริงผู้ดูแลเงินหลัก"),
    ("id_money_guardian_primary",        "เลขบัตรประชาชนผู้ดูแลเงินหลัก"),
    ("fullname_money_guardian_backup",   "ชื่อ-นามสกุลจริงผู้ดูแลเงินสำรอง"),
    ("id_money_guardian_backup",         "เลขบัตรประชาชนผู้ดูแลเงินสำรอง"),
]
...
def build_col_g_prompt(data):
    ...
    lines = [
        ...
        "",
        "=" * 50,
        "ประเด็น 10 — เอกสารอยู่ที่ไหนและใครรู้บ้าง",
        "- ดู documents_location ว่าเก็บที่ไหน ใครรู้บ้าง",
        "- แจ้งว่าคุณพยัตจัดทำคู่มือฉุกเฉินให้เป็นส่วนหนึ่งของเอกสารชุดนี้",
        "- แนะนำให้กรอกข้อมูลจริงในคู่มือและแจ้งผู้จัดการมรดกให้รู้ว่าอยู่ที่ไหน",
        "",
        "=" * 50,
        "ประเด็น 11 — ทบทวนแผนทุกปี",
        "- สรุปสถานะแผนตอนนี้ว่าส่วนไหนทำไปแล้ว ส่วนไหนยังต้องทำต่อ",
        "- แนะนำ review ปีละครั้ง หรือเมื่อชีวิตเปลี่ยน เช่น ลูกเพิ่ม รายได้เปลี่ยน",
        "- เน้นว่าทำก่อนแม้ยังไม่ครบ ดีกว่าไม่มีเลย และค่อยปรับเพิ่มทีหลังได้",
        "",
        "=" * 50,
