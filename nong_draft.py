...
def build_prompt(data):
    ...
    lines = [
        ...
        "3. ประกันชีวิตคุ้มครองรายได้ มูลค่าทางเศรษฐกิจ",
        "4. ประกันโรคร้าย / ทุพพลภาพ",
        "5. ประกันอุบัติเหตุ",
        "6. ที่ดินมรดก — ระบุผู้รับใน Will",
        "7. คู่สมรสแต่งงานใหม่ I Love U Will",
        "8. กรณีคู่สมรสตายก่อนหรือพร้อมกัน  Contingency Clause",
        "9. Business Succession (ถ้ามี) เงินหมุนเวียนในกิจการ",
        ...
        "15. ขั้นตอนหลังเกิดเหตุ ถึงผู้จัดการเรื่อง",
        "16. จดหมายถึงลูกและคู่สมรส",
        "",
        "format:",
