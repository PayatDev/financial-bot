...
def build_guide_docx(client_data: dict) -> str:
    ...
    _row(doc, "แจ้งนายจ้าง",
         "[สถานที่ทำงาน] — ติดต่อ [ชื่อฝ่าย HR หรือหัวหน้างาน] โทร [เบอร์]")
    ...
    _row(doc, "ข้อมูลประกัน",
         "[ชื่อบริษัทประกัน] กรมธรรม์เลข [เลขกรมธรรม์] ทุนประกัน [จำนวน] บาท ผู้รับประโยชน์: [ชื่อผู้รับ]")
    ...
    _row(doc, "สวัสดิการที่มี",
         "[ระบุสวัสดิการที่มี เช่น สวัสดิการนายจ้าง ประกันสุขภาพกลุ่ม กองทุนสำรองเลี้ยงชีพ]")
    ...
    _row(doc, "ผู้จัดการฉุกเฉิน",
         "[ชื่อผู้จัดการฉุกเฉิน]  โทร [เบอร์]")
    _row(doc, "ผู้จัดการมรดก",
         "[ชื่อผู้จัดการมรดก]  โทร [เบอร์]")
    _row(doc, "ทนาย",
